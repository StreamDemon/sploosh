...
| `LANGUAGE_SPEC_PROMPT_CORE.md` | Condensed LLM-facing reference for the language core (excluding §11). CI-enforced ceiling ≤ 5,600 cl100k_base tokens (warn at 90%, fail above 100%). |
